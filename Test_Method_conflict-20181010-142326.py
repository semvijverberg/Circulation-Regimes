...
# full Time series of T95 (june, juli, august summer)
...
varfullspatial = func_mcK.find_region(varfullgl, region='U.S.cluster')[0]
# region mckinnon - only (mcKinnon) summer 
varfull = varfullspatial.sel(time=datesmcK)
func_mcK.xarray_plot(varfull.mean(dim='time')) 
